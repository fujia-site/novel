...
## Configure Wrapper
    ...
    import { EditorContent, EditorRoot } from "@fujia/novel";
    ...
    <Tip>
      ...
      ```tsx
      import { EditorInstance } from "@fujia/novel"
...
```tsx
import { handleCommandNavigation } from "@fujia/novel/extensions";
import { defaultEditorProps, EditorContent } from "@fujia/novel";
